    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			img = element("img");
    			attr_dev(p0, "class", "secret svelte-1bslfrl");
    			add_location(p0, file$1, 6, 8, 74);
    			attr_dev(h10, "class", "svelte-1bslfrl");
    			add_location(h10, file$1, 10, 12, 173);
    			attr_dev(h30, "class", "svelte-1bslfrl");
    			add_location(h30, file$1, 11, 12, 214);
    			attr_dev(p1, "class", "b svelte-1bslfrl");
    			add_location(p1, file$1, 12, 12, 261);
    			attr_dev(div0, "class", "content svelte-1bslfrl");
    			add_location(div0, file$1, 9, 8, 138);
    			attr_dev(section0, "id", "me");
    			attr_dev(section0, "class", "svelte-1bslfrl");
    			add_location(section0, file$1, 5, 4, 47);
    			attr_dev(p2, "class", "secret svelte-1bslfrl");
    			add_location(p2, file$1, 17, 8, 569);
    			attr_dev(h11, "class", "svelte-1bslfrl");
    			add_location(h11, file$1, 21, 12, 670);
    			attr_dev(h31, "class", "svelte-1bslfrl");
    			add_location(h31, file$1, 22, 12, 702);
    			attr_dev(p3, "class", "b svelte-1bslfrl");
    			add_location(p3, file$1, 23, 12, 732);
    			attr_dev(h32, "class", "svelte-1bslfrl");
    			add_location(h32, file$1, 25, 12, 807);
    			attr_dev(p4, "class", "b svelte-1bslfrl");
    			add_location(p4, file$1, 26, 12, 837);
    			attr_dev(h33, "class", "svelte-1bslfrl");
    			add_location(h33, file$1, 28, 12, 978);
    			attr_dev(p5, "class", "b svelte-1bslfrl");
    			add_location(p5, file$1, 29, 12, 1008);
    			attr_dev(div1, "class", "content svelte-1bslfrl");
    			add_location(div1, file$1, 20, 8, 635);
    			attr_dev(section1, "id", "lans");
    			attr_dev(section1, "class", "svelte-1bslfrl");
    			add_location(section1, file$1, 16, 4, 540);
    			attr_dev(p6, "class", "secret svelte-1bslfrl");
    			add_location(p6, file$1, 35, 8, 1146);
    			attr_dev(h12, "class", "svelte-1bslfrl");
    			add_location(h12, file$1, 39, 12, 1247);
    			attr_dev(h34, "class", "svelte-1bslfrl");
    			add_location(h34, file$1, 40, 12, 1282);
    			attr_dev(p7, "class", "b svelte-1bslfrl");
    			add_location(p7, file$1, 42, 20, 1367);
    			attr_dev(li0, "class", "svelte-1bslfrl");
    			add_location(li0, file$1, 42, 16, 1363);
    			attr_dev(p8, "class", "b svelte-1bslfrl");
    			add_location(p8, file$1, 43, 20, 1491);
    			attr_dev(li1, "class", "svelte-1bslfrl");
    			add_location(li1, file$1, 43, 16, 1487);
    			attr_dev(ul0, "class", "svelte-1bslfrl");
    			add_location(ul0, file$1, 41, 12, 1341);
    			attr_dev(h35, "class", "svelte-1bslfrl");
    			add_location(h35, file$1, 45, 12, 1634);
    			attr_dev(p9, "class", "b svelte-1bslfrl");
    			add_location(p9, file$1, 47, 20, 1736);
    			attr_dev(li2, "class", "svelte-1bslfrl");
    			add_location(li2, file$1, 47, 16, 1732);
    			attr_dev(p10, "class", "b svelte-1bslfrl");
    			add_location(p10, file$1, 48, 20, 1826);
    			attr_dev(li3, "class", "svelte-1bslfrl");
    			add_location(li3, file$1, 48, 16, 1822);
    			attr_dev(p11, "class", "b svelte-1bslfrl");
    			add_location(p11, file$1, 49, 20, 1951);
    			attr_dev(li4, "class", "svelte-1bslfrl");
    			add_location(li4, file$1, 49, 16, 1947);
    			attr_dev(p12, "class", "b svelte-1bslfrl");
    			add_location(p12, file$1, 50, 20, 2097);
    			attr_dev(li5, "class", "svelte-1bslfrl");
    			add_location(li5, file$1, 50, 16, 2093);
    			attr_dev(p13, "class", "b svelte-1bslfrl");
    			add_location(p13, file$1, 51, 20, 2241);
    			attr_dev(li6, "class", "svelte-1bslfrl");
    			add_location(li6, file$1, 51, 16, 2237);
    			attr_dev(ul1, "class", "svelte-1bslfrl");
    			add_location(ul1, file$1, 46, 12, 1710);
    			attr_dev(div2, "class", "content svelte-1bslfrl");
    			add_location(div2, file$1, 38, 8, 1212);
    			attr_dev(section2, "id", "edu");
    			attr_dev(section2, "class", "svelte-1bslfrl");
    			add_location(section2, file$1, 34, 4, 1118);
    			attr_dev(p14, "class", "secret svelte-1bslfrl");
    			add_location(p14, file$1, 57, 8, 2430);
    			attr_dev(h13, "class", "svelte-1bslfrl");
    			add_location(h13, file$1, 61, 12, 2533);
    			attr_dev(h36, "class", "svelte-1bslfrl");
    			add_location(h36, file$1, 62, 12, 2576);
    			attr_dev(p15, "class", "b svelte-1bslfrl");
    			add_location(p15, file$1, 63, 12, 2610);
    			attr_dev(h37, "class", "svelte-1bslfrl");
    			add_location(h37, file$1, 65, 12, 2835);
    			attr_dev(p16, "class", "b svelte-1bslfrl");
    			add_location(p16, file$1, 66, 12, 2863);
    			attr_dev(h38, "class", "svelte-1bslfrl");
    			add_location(h38, file$1, 68, 12, 2995);
    			attr_dev(p17, "class", "b svelte-1bslfrl");
    			add_location(p17, file$1, 69, 12, 3025);
    			attr_dev(div3, "class", "content svelte-1bslfrl");
    			add_location(div3, file$1, 60, 8, 2498);
    			attr_dev(section3, "id", "interests");
    			attr_dev(section3, "class", "svelte-1bslfrl");
    			add_location(section3, file$1, 56, 4, 2396);
    			attr_dev(p18, "class", "secret svelte-1bslfrl");
    			add_location(p18, file$1, 74, 8, 3181);
    			attr_dev(h14, "class", "svelte-1bslfrl");
    			add_location(h14, file$1, 78, 12, 3281);
    			attr_dev(h39, "class", "svelte-1bslfrl");
    			add_location(h39, file$1, 79, 12, 3313);
    			attr_dev(p19, "class", "b svelte-1bslfrl");
