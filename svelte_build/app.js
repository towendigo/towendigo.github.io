    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$2, 21, 35, 531);
    			attr_dev(header, "class", "contact-title svelte-nnjt76");
    			add_location(header, file$2, 21, 4, 500);
    			...
    			add_location(img0, file$2, 24, 29, 614);
    			attr_dev(h41, "class", "svelte-nnjt76");
    			add_location(h41, file$2, 24, 76, 661);
    			attr_dev(a0, "href", "/");
    			attr_dev(a0, "class", "svelte-nnjt76");
    			add_location(a0, file$2, 24, 16, 601);
    			add_location(li0, file$2, 24, 12, 597);
    			attr_dev(hr0, "class", "svelte-nnjt76");
    			add_location(hr0, file$2, 25, 12, 723);
    			...
    			add_location(img1, file$2, 26, 29, 757);
    			attr_dev(h42, "class", "svelte-nnjt76");
    			add_location(h42, file$2, 26, 77, 805);
    			attr_dev(a1, "href", "/");
    			attr_dev(a1, "class", "svelte-nnjt76");
    			add_location(a1, file$2, 26, 16, 744);
    			add_location(li1, file$2, 26, 12, 740);
    			attr_dev(hr1, "class", "svelte-nnjt76");
    			add_location(hr1, file$2, 27, 12, 884);
    			...
    			add_location(img2, file$2, 28, 29, 918);
    			attr_dev(h43, "class", "svelte-nnjt76");
    			add_location(h43, file$2, 28, 72, 961);
    			attr_dev(a2, "href", "/");
    			attr_dev(a2, "class", "svelte-nnjt76");
    			add_location(a2, file$2, 28, 16, 905);
    			add_location(li2, file$2, 28, 12, 901);
    			attr_dev(hr2, "class", "svelte-nnjt76");
    			add_location(hr2, file$2, 29, 12, 1021);
    			attr_dev(ul, "class", "svelte-nnjt76");
    			add_location(ul, file$2, 23, 8, 580);
    			attr_dev(nav, "class", "svelte-nnjt76");
    			add_location(nav, file$2, 22, 4, 566);
    			attr_dev(p, "class", "b");
    			add_location(p, file$2, 34, 8, 1089);
    			attr_dev(h44, "class", "svelte-nnjt76");
    			add_location(h44, file$2, 35, 84, 1217);
    			attr_dev(h45, "class", "svelte-nnjt76");
    			add_location(h45, file$2, 35, 105, 1238);
    			attr_dev(a3, "href", "./static/AKIF_SAHIN_KORKMAZ.pdf");
    			attr_dev(a3, "download", "Akif_Sahin_Korkmaz_CV");
    			attr_dev(a3, "class", "svelte-nnjt76");
    			add_location(a3, file$2, 35, 8, 1141);
    			attr_dev(div, "class", "resume svelte-nnjt76");
    			add_location(div, file$2, 33, 4, 1060);
    			attr_dev(footer, "class", "svelte-nnjt76");
    			add_location(footer, file$2, 20, 0, 467);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p2 = element("p");
    			p2.textContent = "#MyInterests";
    			t9 = space();
    			div1 = element("div");
    			h11 = element("h1");
    			h11.textContent = "I Am Interested In ~";
    			t11 = space();
    			h31 = element("h3");
    			h31.textContent = "Programming";
    			t13 = space();
    			p3 = element("p");
    			p3.textContent = "I like learning new technologies, using them in projects. I really like seeing something i contributed live. I also like solving problems. That sums up my interest in programming.";
    			t15 = space();
    			h32 = element("h3");
    			h32.textContent = "Music";
    			t17 = space();
    			p4 = element("p");
    			p4.textContent = "I am a big fan of music. Also play guitar. My music taste varies between today's pop and 70s' rock.";
    			t19 = space();
    			h33 = element("h3");
    			h33.textContent = "Animals";
    			t21 = space();
    			p5 = element("p");
    			p5.textContent = "I love animals, specifically cats. I am a volunteer stray animal feeder.";
    			t23 = space();
    			section2 = element("section");
    			p6 = element("p");
    			p6.textContent = "#MyEducation";
    			t25 = space();
    			div2 = element("div");
    			h12 = element("h1");
    			...
    			p14 = element("p");
    			p14.textContent = "#MyResume";
    			t47 = space();
    			div4 = element("div");
    			h13 = element("h1");
    			h13.textContent = "My Resume";
    			t49 = space();
    			h36 = element("h3");
    			h36.textContent = "For more information ~";
    			t51 = space();
    			p15 = element("p");
    			p15.textContent = "You can contact me or download my resume by clicking the image.";
    			t53 = space();
    			div3 = element("div");
    			a = element("a");
    			img = element("img");
    			attr_dev(p0, "class", "secret svelte-sljjcq");
    			add_location(p0, file$1, 6, 8, 68);
    			attr_dev(h10, "class", "svelte-sljjcq");
    			add_location(h10, file$1, 10, 12, 163);
    			attr_dev(h30, "class", "svelte-sljjcq");
    			add_location(h30, file$1, 11, 12, 203);
    			attr_dev(p1, "class", "b svelte-sljjcq");
    			add_location(p1, file$1, 12, 12, 249);
    			attr_dev(div0, "class", "content");
    			add_location(div0, file$1, 9, 8, 129);
    			attr_dev(section0, "id", "me");
    			attr_dev(section0, "class", "svelte-sljjcq");
    			add_location(section0, file$1, 5, 4, 42);
    			attr_dev(p2, "class", "secret svelte-sljjcq");
    			add_location(p2, file$1, 17, 8, 557);
    			attr_dev(h11, "class", "svelte-sljjcq");
    			add_location(h11, file$1, 21, 12, 656);
    			attr_dev(h31, "class", "svelte-sljjcq");
    			add_location(h31, file$1, 22, 12, 698);
    			attr_dev(p3, "class", "b svelte-sljjcq");
    			add_location(p3, file$1, 23, 12, 731);
    			attr_dev(h32, "class", "svelte-sljjcq");
    			add_location(h32, file$1, 25, 12, 954);
    			attr_dev(p4, "class", "b svelte-sljjcq");
    			add_location(p4, file$1, 26, 12, 981);
    			attr_dev(h33, "class", "svelte-sljjcq");
    			add_location(h33, file$1, 28, 12, 1111);
    			attr_dev(p5, "class", "b svelte-sljjcq");
    			add_location(p5, file$1, 29, 12, 1140);
    			attr_dev(div1, "class", "content");
    			add_location(div1, file$1, 20, 8, 622);
    			attr_dev(section1, "id", "interests");
    			attr_dev(section1, "class", "svelte-sljjcq");
    			add_location(section1, file$1, 16, 4, 524);
    			attr_dev(p6, "class", "secret svelte-sljjcq");
    			add_location(p6, file$1, 34, 8, 1292);
    			attr_dev(h12, "class", "svelte-sljjcq");
    			add_location(h12, file$1, 38, 12, 1391);
    			attr_dev(h34, "class", "svelte-sljjcq");
    			add_location(h34, file$1, 39, 12, 1425);
    			attr_dev(p7, "class", "b svelte-sljjcq");
    			add_location(p7, file$1, 41, 20, 1508);
    			add_location(li0, file$1, 41, 16, 1504);
    			attr_dev(p8, "class", "b svelte-sljjcq");
    			add_location(p8, file$1, 42, 20, 1631);
    			add_location(li1, file$1, 42, 16, 1627);
    			attr_dev(ul0, "class", "svelte-sljjcq");
    			add_location(ul0, file$1, 40, 12, 1483);
    			attr_dev(h35, "class", "svelte-sljjcq");
    			add_location(h35, file$1, 44, 12, 1772);
    			attr_dev(p9, "class", "b svelte-sljjcq");
    			add_location(p9, file$1, 46, 20, 1872);
    			add_location(li2, file$1, 46, 16, 1868);
    			attr_dev(p10, "class", "b svelte-sljjcq");
    			add_location(p10, file$1, 47, 20, 1961);
    			add_location(li3, file$1, 47, 16, 1957);
    			attr_dev(p11, "class", "b svelte-sljjcq");
    			add_location(p11, file$1, 48, 20, 2085);
    			add_location(li4, file$1, 48, 16, 2081);
    			attr_dev(p12, "class", "b svelte-sljjcq");
    			add_location(p12, file$1, 49, 20, 2230);
    			add_location(li5, file$1, 49, 16, 2226);
    			attr_dev(p13, "class", "b svelte-sljjcq");
    			add_location(p13, file$1, 50, 20, 2373);
    			add_location(li6, file$1, 50, 16, 2369);
    			attr_dev(ul1, "class", "svelte-sljjcq");
    			add_location(ul1, file$1, 45, 12, 1847);
    			attr_dev(div2, "class", "content");
    			add_location(div2, file$1, 37, 8, 1357);
    			attr_dev(section2, "id", "edu");
    			attr_dev(section2, "class", "svelte-sljjcq");
    			add_location(section2, file$1, 33, 4, 1265);
    			attr_dev(p14, "class", "secret svelte-sljjcq");
    			add_location(p14, file$1, 56, 8, 2538);
    			attr_dev(h13, "class", "svelte-sljjcq");
    			add_location(h13, file$1, 60, 12, 2634);
    			attr_dev(h36, "class", "svelte-sljjcq");
    			add_location(h36, file$1, 61, 12, 2665);
    			attr_dev(p15, "class", "b svelte-sljjcq");
    			add_location(p15, file$1, 62, 12, 2709);
    			...
    			attr_dev(img, "class", "svelte-sljjcq");
    			add_location(img, file$1, 66, 20, 2937);
    			attr_dev(a, "href", "./static/AKIF_SAHIN_KORKMAZ.pdf");
    			attr_dev(a, "download", "Akif_Sahin_Korkmaz_CV");
    			attr_dev(a, "class", "svelte-sljjcq");
    			add_location(a, file$1, 65, 16, 2840);
    			attr_dev(div3, "class", "resume");
    			add_location(div3, file$1, 64, 12, 2803);
    			attr_dev(div4, "class", "content");
    			add_location(div4, file$1, 59, 8, 2600);
    			attr_dev(section3, "id", "cv");
    			attr_dev(section3, "class", "svelte-sljjcq");
    			add_location(section3, file$1, 55, 4, 2512);
    			attr_dev(div5, "id", "About");
    			add_location(div5, file$1, 4, 0, 21);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 16, 0, 253);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
